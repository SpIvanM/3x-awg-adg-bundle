...
Assert-Contains -Text $setup -Needle '"$XRAY_BIN" x25519 -i "$fallback_private_key" 2>&1' -Message 'setup.sh must derive the Reality public key from the fallback private key.'
