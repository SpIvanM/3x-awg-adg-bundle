...
Description: Validates that setup and uninstall scripts keep critical fixes for piped execution, non-interactive 3x-ui installation, DNS redirect cleanup, and AdGuardHome config writes.
